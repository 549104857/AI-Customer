...
**AI-RedBox ** 是一个面向小红书创作者与内容团队的本地化 AI 工作台，把 **内容采集、知识沉淀、选题发散、稿件生产、自动化执行、主体资产管理、媒体与封面生成** 串成一条完整工作流。
...
1. 在 [Releases](https://github.com/58lxf58/AI-RedBox/releases) 下载并安装。
